...
################################################################################
## Form generated from reading UI file 'invalid_url_windowkwQaVx.ui'
##
...
class Ui_Invalid_Link_Window(object):
    def setupUi(self, Invalid_Link_Window):
        if not Invalid_Link_Window.objectName():
            Invalid_Link_Window.setObjectName(u"Invalid_Link_Window")
        Invalid_Link_Window.setWindowModality(Qt.ApplicationModal)
        Invalid_Link_Window.resize(528, 474)
        Invalid_Link_Window.setStyleSheet(u"background-color: rgb(255, 255, 255);")
        self.centralwidget = QWidget(Invalid_Link_Window)
        ...
        Invalid_Link_Window.setCentralWidget(self.centralwidget)

        self.retranslateUi(Invalid_Link_Window)

        QMetaObject.connectSlotsByName(Invalid_Link_Window)
    # setupUi

    def retranslateUi(self, Invalid_Link_Window):
        Invalid_Link_Window.setWindowTitle(QCoreApplication.translate("Invalid_Link_Window", u"Invalid URL", None))
        self.minimize_button.setText("")
        self.exit_button.setText("")
        self.alert_icon.setText("")
        self.error_text.setText(QCoreApplication.translate("Invalid_Link_Window", u"Invalid URL.", None))
        self.OK_button.setText(QCoreApplication.translate("Invalid_Link_Window", u"OK", None))
    # retranslateUi
